#include "native_halo4.h"

#include <cstring>

CNativeInfo Halo4::Native::s_nativeInfo;

INDEX Halo4::Native::Function::local_player_add(const wchar_t *name, const wchar_t *id) {
    ...
    auto p_action = s_nativeInfo.getEntryAddress(OFFSET_HALO4_V_ENTRY_PLAYERS_ACTION);
    ...
    return (func_init_t(s_nativeInfo.getModuleAddress() + OFFSET_HALO4_PF_ADD_LOCAL_PLAYER))(index, &new_player, false);
}
