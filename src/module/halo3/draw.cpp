...
namespace Halo3::Entry::Draw {
    ...
    ::Entry entry_structure{OFFSET_HALO3_PF_DRAW_STRUCTURE, detour1};
    ::Entry entry_model{OFFSET_HALO3_PF_DRAW_MODEL, detour2};
}
...
__int64 Halo3::Entry::Draw::detour1(unsigned int a1, __int64 a2, __int64 a3, __int64 a4) {
    ...
    auto func = (func_t) entry_structure.pOriginal();
    Prologue(1);
...
__int64 Halo3::Entry::Draw::detour2(__int64 p_render_model, __int64 a2) {
    ...
    auto func = (func_t) entry_model.pOriginal();
    Prologue(2);
